                ...
                <div className={`${styles['container-dashboard']} pt-5`}>
                    <div className={`${styles['c-dashboardInfo']} col-lg-3 col-md-6`}>
                        <div className={styles.wrap}>
                            <h4 className={`${styles.heading} ${styles['heading5']} ${styles['hind-font']} ${styles['medium-font-weight']} ${styles['c-dashboardInfo__title']}`}>
                                Total Incidents
                                <svg
                            ...
                            <span className={`${styles['hind-font']} ${styles['caption-12']} ${styles['c-dashboardInfo__count']}`}>
